...
taskRouter.get('/task/getTasks', (req, res) => {
...
taskRouter.post('/task/getTaskById', jsonParser, (req, res) => {
...
taskRouter.post('/task/addTask', jsonParser, async (req, res) => {
    const task = new Task({
...
taskRouter.post('/task/updateTask', jsonParser, (req, res) => {
    if (!req.body.newTask)
...
taskRouter.post('/task/removeTask', jsonParser, (req, res) => {
    const id = req.body.id;
